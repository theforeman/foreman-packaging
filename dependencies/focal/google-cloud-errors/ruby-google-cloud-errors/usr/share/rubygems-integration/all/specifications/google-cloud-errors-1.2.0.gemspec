...
Gem::Specification.new do |s|
  ...
  s.files = [".yardopts".freeze, "CODE_OF_CONDUCT.md".freeze, "CONTRIBUTING.md".freeze, "LICENSE".freeze, "README.md".freeze, "lib/google-cloud-errors.rb".freeze, "lib/google/cloud/errors.rb".freeze, "lib/google/cloud/errors/version.rb".freeze]
