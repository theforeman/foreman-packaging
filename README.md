...
Use `%gemspec_remove_dep -g <GEM_NAME>` to drop the gem from the gemspec and manually add a dependency on ruby-default-gems as a rich dependency: `(rubygem(<GEM_NAME>) or ruby-default-gems < 3.4)`.
