...
#
%global	gem_dir	%(ruby -rrbconfig -e 'puts File::expand_path(File::join(RbConfig::CONFIG["sitedir"],"..","gems"))')
%global	rb_ver		%(ruby -rrbconfig -e 'puts RbConfig::CONFIG["ruby_version"]')
