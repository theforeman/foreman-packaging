...
# is resolved
BuildRequires: %{?scl_prefix}npm(babel-core) < 6.8.0
BuildRequires: %{?scl_prefix}npm(babel-core) >= 6.7.2
BuildRequires: %{?scl_prefix}npm(babel-loader) < 6.3.0
BuildRequires: %{?scl_prefix}npm(babel-loader) >= 6.2.4
...
BuildRequires: %{?scl_prefix}npm(babel-preset-es2015) < 6.7.0
BuildRequires: %{?scl_prefix}npm(babel-preset-es2015) >= 6.6.0
...
BuildRequires: %{?scl_prefix}npm(datatables.net) >= 1.10.12
BuildRequires: %{?scl_prefix}npm(datatables.net) < 1.11.0
BuildRequires: %{?scl_prefix}npm(datatables.net-bs) >= 1.10.12
BuildRequires: %{?scl_prefix}npm(datatables.net-bs) < 1.11.0
BuildRequires: %{?scl_prefix}npm(diff) >= 3.0.0
BuildRequires: %{?scl_prefix}npm(diff) < 3.1.0
BuildRequires: %{?scl_prefix}npm(es6-promise) < 4.0.0
BuildRequires: %{?scl_prefix}npm(es6-promise) >= 3.2.1
BuildRequires: %{?scl_prefix}npm(expose-loader) < 0.7.0
BuildRequires: %{?scl_prefix}npm(expose-loader) >= 0.6.0
BuildRequires: %{?scl_prefix}npm(extract-text-webpack-plugin) < 2.0.0
BuildRequires: %{?scl_prefix}npm(extract-text-webpack-plugin) >= 1.0.1
BuildRequires: %{?scl_prefix}npm(file-loader) < 1.0.0
BuildRequires: %{?scl_prefix}npm(file-loader) >= 0.9.0
BuildRequires: %{?scl_prefix}npm(flux) >= 2.1.1
BuildRequires: %{?scl_prefix}npm(flux) < 3.0.0
BuildRequires: %{?scl_prefix}npm(ipaddr.js) >= 1.2.0
BuildRequires: %{?scl_prefix}npm(ipaddr.js) < 1.3.0
BuildRequires: %{?scl_prefix}npm(jquery) < 1.12.0
BuildRequires: %{?scl_prefix}npm(jquery) >= 1.11.0
BuildRequires: %{?scl_prefix}npm(jquery-flot) < 0.9.0
BuildRequires: %{?scl_prefix}npm(jquery-flot) >= 0.8.3
BuildRequires: %{?scl_prefix}npm(jquery-ujs) < 1.3.0
BuildRequires: %{?scl_prefix}npm(jquery-ujs) >= 1.2.0
BuildRequires: %{?scl_prefix}npm(jquery.cookie) < 1.5.0
BuildRequires: %{?scl_prefix}npm(jquery.cookie) >= 1.4.1
BuildRequires: %{?scl_prefix}npm(jstz) < 1.1.0
BuildRequires: %{?scl_prefix}npm(jstz) >= 1.0.7
BuildRequires: %{?scl_prefix}npm(lodash) >= 4.15.0
BuildRequires: %{?scl_prefix}npm(lodash) < 4.16.0
BuildRequires: %{?scl_prefix}npm(multiselect) >= 0.9.12
BuildRequires: %{?scl_prefix}npm(multiselect) < 0.10.0
BuildRequires: %{?scl_prefix}npm(react) >= 15.1.0
BuildRequires: %{?scl_prefix}npm(react) < 16.0.0
BuildRequires: %{?scl_prefix}npm(react-bootstrap) >= 0.30.0
BuildRequires: %{?scl_prefix}npm(react-bootstrap) < 1.0.0
BuildRequires: %{?scl_prefix}npm(react-dom) >= 15.1.0
BuildRequires: %{?scl_prefix}npm(react-dom) < 16.0.0
BuildRequires: %{?scl_prefix}npm(select2) >= 3.5.2
BuildRequires: %{?scl_prefix}npm(select2) < 3.6.0
BuildRequires: %{?scl_prefix}npm(stats-webpack-plugin) < 1.0.0
BuildRequires: %{?scl_prefix}npm(stats-webpack-plugin) >= 0.2.1
BuildRequires: %{?scl_prefix}npm(style-loader) < 1.0.0
BuildRequires: %{?scl_prefix}npm(style-loader) >= 0.13.1
BuildRequires: %{?scl_prefix}npm(url-loader) < 1.0.0
BuildRequires: %{?scl_prefix}npm(url-loader) >= 0.5.7
BuildRequires: %{?scl_prefix}npm(webpack) < 2.0.0
BuildRequires: %{?scl_prefix}npm(webpack) >= 1.9.11
...
BuildRequires: %{?scl_prefix}rubygem(patternfly-sass) >= 3.15.0
BuildRequires: %{?scl_prefix}rubygem(patternfly-sass) < 3.16.0
...
Group:  Applications/System
Requires: %{?scl_prefix}rubygem(fog-vsphere) >= 1.6.0
Requires: %{name} = %{version}-%{release}
...
# Temporary dep on libuv until https://bugs.centos.org/view.php?id=10606
# is resolved
Requires: %{?scl_prefix}npm(babel-core) < 6.8.0
Requires: %{?scl_prefix}npm(babel-core) >= 6.7.2
Requires: %{?scl_prefix}npm(babel-loader) < 6.3.0
Requires: %{?scl_prefix}npm(babel-loader) >= 6.2.4
...
Requires: %{?scl_prefix}npm(babel-preset-es2015) < 6.7.0
Requires: %{?scl_prefix}npm(babel-preset-es2015) >= 6.6.0
...
Requires: %{?scl_prefix}npm(c3) < 1.0.0
Requires: %{?scl_prefix}npm(css-loader) < 1.0.0
Requires: %{?scl_prefix}npm(css-loader) >= 0.23.1
Requires: %{?scl_prefix}npm(datatables.net) >= 1.10.12
Requires: %{?scl_prefix}npm(datatables.net) < 1.11.0
Requires: %{?scl_prefix}npm(datatables.net-bs) >= 1.10.12
Requires: %{?scl_prefix}npm(datatables.net-bs) < 1.11.0
Requires: %{?scl_prefix}npm(diff) >= 3.0.0
Requires: %{?scl_prefix}npm(diff) < 3.1.0
Requires: %{?scl_prefix}npm(es6-promise) < 4.0.0
Requires: %{?scl_prefix}npm(es6-promise) >= 3.2.1
Requires: %{?scl_prefix}npm(expose-loader) < 0.7.0
Requires: %{?scl_prefix}npm(expose-loader) >= 0.6.0
Requires: %{?scl_prefix}npm(extract-text-webpack-plugin) < 2.0.0
Requires: %{?scl_prefix}npm(extract-text-webpack-plugin) >= 1.0.1
Requires: %{?scl_prefix}npm(file-loader) < 1.0.0
Requires: %{?scl_prefix}npm(file-loader) >= 0.9.0
Requires: %{?scl_prefix}npm(flux) >= 2.1.1
Requires: %{?scl_prefix}npm(flux) < 3.0.0
Requires: %{?scl_prefix}npm(ipaddr.js) >= 1.2.0
Requires: %{?scl_prefix}npm(ipaddr.js) < 1.3.0
Requires: %{?scl_prefix}npm(jquery) < 1.12.0
Requires: %{?scl_prefix}npm(jquery) >= 1.11.0
Requires: %{?scl_prefix}npm(jquery-flot) < 0.9.0
Requires: %{?scl_prefix}npm(jquery-flot) >= 0.8.3
Requires: %{?scl_prefix}npm(jquery-ujs) < 1.3.0
Requires: %{?scl_prefix}npm(jquery-ujs) >= 1.2.0
Requires: %{?scl_prefix}npm(jquery.cookie) < 1.5.0
Requires: %{?scl_prefix}npm(jquery.cookie) >= 1.4.1
Requires: %{?scl_prefix}npm(jstz) < 1.1.0
Requires: %{?scl_prefix}npm(jstz) >= 1.0.7
Requires: %{?scl_prefix}npm(lodash) >= 4.15.0
Requires: %{?scl_prefix}npm(lodash) < 4.16.0
Requires: %{?scl_prefix}npm(multiselect) >= 0.9.12
Requires: %{?scl_prefix}npm(multiselect) < 0.10.0
Requires: %{?scl_prefix}npm(react) >= 15.1.0
Requires: %{?scl_prefix}npm(react) < 16.0.0
Requires: %{?scl_prefix}npm(react-bootstrap) >= 0.30.0
Requires: %{?scl_prefix}npm(react-bootstrap) < 1.0.0
Requires: %{?scl_prefix}npm(react-dom) >= 15.1.0
Requires: %{?scl_prefix}npm(react-dom) < 16.0.0
Requires: %{?scl_prefix}npm(select2) >= 3.5.2
Requires: %{?scl_prefix}npm(select2) < 3.6.0
Requires: %{?scl_prefix}npm(stats-webpack-plugin) < 1.0.0
Requires: %{?scl_prefix}npm(stats-webpack-plugin) >= 0.2.1
Requires: %{?scl_prefix}npm(style-loader) < 1.0.0
Requires: %{?scl_prefix}npm(style-loader) >= 0.13.1
Requires: %{?scl_prefix}npm(url-loader) < 1.0.0
Requires: %{?scl_prefix}npm(url-loader) >= 0.5.7
Requires: %{?scl_prefix}npm(webpack) < 2.0.0
Requires: %{?scl_prefix}npm(webpack) >= 1.9.11
...
Requires: %{?scl_prefix}rubygem(patternfly-sass) >= 3.15.0
Requires: %{?scl_prefix}rubygem(patternfly-sass) < 3.16.0
...
ls -la %{?_scl_prefix}/tfm/root/%{nodejs_sitelib}/
ln -s %{?_scl_prefix}/tfm/root/%{nodejs_sitelib} node_modules
