...
Requires: %{?scl_prefix}rubygem(dry-container) >= 0.3
...
Requires: %{?scl_prefix}rubygem(dry-core) >= 0.5
Requires: %{?scl_prefix}rubygem(dry-inflector) >= 0.1
Requires: %{?scl_prefix}rubygem(dry-inflector) < 1
Requires: %{?scl_prefix}rubygem(dry-inflector) >= 0.1.2
Requires: %{?scl_prefix}rubygem(dry-logic) >= 1.0
Requires: %{?scl_prefix}rubygem(dry-logic) < 2
Requires: %{?scl_prefix}rubygem(dry-logic) >= 1.0.2
...
%{gem_instdir}/dry-types.gemspec

%changelog
* Tue Jul 28 2026 Zach Huntington-Meath <zhunting@redhat.com> - 1.5.1-2
- Rebuild for EL10

* Tue May 31 2022 Dirk Goetz <dirk.goetz@netways.de> 1.5.1-1
- Add rubygem-dry-types generated by gem2rpm using the scl template
