...
%global gem_name rbnacl-libsodium
...
Requires: %{?scl_prefix}rubygem(rbnacl) >= 3.0.1
BuildRequires: %{?scl_prefix_ruby}ruby(release)
BuildRequires: %{?scl_prefix_ruby}ruby-devel >= 2.2.6
BuildRequires: %{?scl_prefix_ruby}rubygems-devel
BuildRequires: %{?scl_prefix}rubygem(rbnacl) >= 3.0.1
...
%{gem_instdir}/rbnacl-libsodium.gemspec

%changelog
* Tue Jul 20 2021 Adam Ruzicka <aruzicka@redhat.com> 1.0.16-1
- Add rubygem-rbnacl-libsodium generated by gem2rpm using the scl template
