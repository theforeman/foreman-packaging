...
BuildRequires: (rubygem(deface) >= 1.9 with rubygem(deface) < 2)
BuildArch: noarch
...
%changelog
* Fri Jul 31 2026 Zach Huntington-Meath <zhunting@redhat.com> - 4.0.1-2
- Rebuild for EL10

* Thu Sep 25 2025 Vitaly Pyslar <vpyslar@ivi.ru> - 4.0.1-1
