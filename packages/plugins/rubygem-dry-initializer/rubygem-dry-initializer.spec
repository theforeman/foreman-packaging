...
%global gem_name dry-initializer
...
%{gem_instdir}/dry-initializer.gemspec

%changelog
* Tue May 31 2022 Dirk Goetz <dirk.goetz@netways.de> 3.1.1-1
- Add rubygem-dry-initializer generated by gem2rpm using the scl template
