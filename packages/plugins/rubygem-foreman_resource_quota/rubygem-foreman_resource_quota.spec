...
BuildRequires: (rubygem(foreman-tasks) >= 10.0 with rubygem(foreman-tasks) < 14)
BuildArch: noarch
...
%changelog
* Wed Aug 05 2026 Foreman Packaging Automation <packaging@theforeman.org> - 0.6.5-1
- Update to 0.6.5
...
* Mon Nov 17 2025 Evgeni Golov - 0.6.1-2
