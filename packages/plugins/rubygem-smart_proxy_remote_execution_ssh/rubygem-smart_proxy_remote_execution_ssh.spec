# Generated from smart_proxy_remote_execution_ssh-0.2.1.gem by gem2rpm -*- rpm-spec -*-
...
mv .%{gem_instdir}/bundler.plugins.d/remote_execution_ssh.rb \
...
%changelog
* Tue Sep 17 2019 Eric D. Helms <ericdhelms@gmail.com> 0.2.1-1
- Update to 0.2.1-1
