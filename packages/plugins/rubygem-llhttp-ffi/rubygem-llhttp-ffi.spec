...
BuildRequires: rubygem(ffi-compiler) >= 1.0
BuildRequires: rubygem(ffi-compiler) < 2
BuildRequires: rubygem(rake) >= 13.0
BuildRequires: rubygem(rake) < 14
...
%changelog
* Thu Dec 15 2022 Manuel Laug <laugmanuel@gmail.com> 0.4.0-1
