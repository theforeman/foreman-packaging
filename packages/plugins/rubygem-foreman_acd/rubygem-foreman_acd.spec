...
mkdir -p %{buildroot}%{_sharedstatedir}/foreman/%{gem_name}/ansible-playbooks/
...
%attr(-,foreman,foreman) %{_sharedstatedir}/foreman/%{gem_name}
%attr(-,foreman,foreman) %{_sharedstatedir}/foreman/%{gem_name}/ansible-playbooks/
...
%changelog
* Mon May 08 2023 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 0.9.4-2
- Let rubygem-git depend on git
- Remove SCL macros
