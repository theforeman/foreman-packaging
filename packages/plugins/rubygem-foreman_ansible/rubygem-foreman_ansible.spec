...
BuildRequires: rubygem(foreman_remote_execution) >= 8.0.0
BuildRequires: rubygem(foreman-tasks) >= 7.0.0
...
%changelog
* Sun Oct 02 2022 Foreman Packaging Automation <packaging@theforeman.org> 10.0.0-1
- Update to 10.0.0
