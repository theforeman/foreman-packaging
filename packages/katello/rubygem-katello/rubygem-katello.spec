...
BuildRequires: (rubygem(pulpcore_client) >= 3.118.0 with rubygem(pulpcore_client) < 3.119.0)
BuildRequires: (rubygem(pulp_file_client) >= 3.118.0 with rubygem(pulp_file_client) < 3.119.0)
BuildRequires: (rubygem(pulp_ansible_client) >= 0.30.0 with rubygem(pulp_ansible_client) < 0.31.0)
BuildRequires: (rubygem(pulp_container_client) >= 2.29.0 with rubygem(pulp_container_client) < 2.30.0)
BuildRequires: (rubygem(pulp_deb_client) >= 3.11.1 with rubygem(pulp_deb_client) < 3.12.0)
BuildRequires: (rubygem(pulp_rpm_client) >= 3.39.0 with rubygem(pulp_rpm_client) < 3.40.0)
BuildRequires: (rubygem(pulp_certguard_client) >= 3.118.0 with rubygem(pulp_certguard_client) < 3.119.0)
BuildRequires: (rubygem(pulp_python_client) >= 3.36.2 with rubygem(pulp_python_client) < 3.37.0)
BuildRequires: (rubygem(pulp_ostree_client) >= 2.6.1 with rubygem(pulp_ostree_client) < 2.7.0)
...
%changelog
* Thu Sep 24 2026 Samir Jha <samirjha1525@gmail.com> - 5.1.0-0.2.pre.master
- Bump Pulp binding requirements to 3.118 versions
