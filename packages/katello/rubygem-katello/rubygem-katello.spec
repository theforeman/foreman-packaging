...
Requires: %{?scl_prefix}rubygem(pulp_ansible_client) < 0.11
Requires: %{?scl_prefix}rubygem(pulp_container_client) >= 2.9.0
Requires: %{?scl_prefix}rubygem(pulp_container_client) < 2.10.0
Requires: %{?scl_prefix}rubygem(pulp_deb_client) >= 2.16.0
Requires: %{?scl_prefix}rubygem(pulp_deb_client) < 2.17.0
...
BuildRequires: %{?scl_prefix}rubygem(pulp_ansible_client) < 0.11
BuildRequires: %{?scl_prefix}rubygem(pulp_container_client) >= 2.9.0
BuildRequires: %{?scl_prefix}rubygem(pulp_container_client) < 2.10.0
BuildRequires: %{?scl_prefix}rubygem(pulp_deb_client) >= 2.16.0
BuildRequires: %{?scl_prefix}rubygem(pulp_deb_client) < 2.17.0
...
* Wed Jun 01 2022 Odilon Sousa <osousa@redhat.com> - 4.4.1-1
- Release rubygem-katello 4.4.1

* Mon Apr 11 2022 Zach Huntington-Meath <zhunting@redhat.com> - 4.4.0.2-2
- rebuilt

* Mon Apr 11 2022 ianballou <ianballou67@gmail.com> 4.4.0.2-1
- Update to 4.4.0.2

* Fri Apr 01 2022 ianballou <ianballou67@gmail.com> 4.4.0.1-1
- Update to 4.4.0.1

* Mon Mar 21 2022 Zach Huntington-Meath <zhunting@redhat.com> - 4.4.0-1
- Release rubygem-katello 4.4.0

* Thu Mar 03 2022 Zach Huntington-Meath <zhunting@redhat.com> - 4.4.0-0.4.rc2
- Release rubygem-katello 4.4.0rc2

* Mon Feb 28 2022 Justin Sherrill <jsherril@redhat.com> 4.4.0-0.3.rc1
