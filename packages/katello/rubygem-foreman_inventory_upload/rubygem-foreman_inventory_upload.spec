# Generated from foreman_inventory_upload-1.0.0.beta2.gem by gem2rpm -*- rpm-spec -*-
...
BuildRequires: npm(react-animated-tree) >= 1.0.10
BuildRequires: npm(react-animated-tree) < 2.0.0
...
%changelog
* Mon Sep 09 2019 Shimon Shtein <sshtein@redhat.com> 1.0.0.beta2-1
- Update to 1.0.0.beta2-1
