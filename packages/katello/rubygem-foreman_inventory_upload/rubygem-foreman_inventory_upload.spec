# Generated from foreman_inventory_upload-1.0.0.beta4.gem by gem2rpm -*- rpm-spec -*-
...
%changelog
* Thu Sep 12 2019 laviro <1ronlavi@gmail.com> 1.0.0.beta5-1
- Update to 1.0.0.beta5

* Wed Sep 11 2019 Shimon Shtein <sshtein@redhat.com> 1.0.0.beta4-1
