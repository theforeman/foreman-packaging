...
%global full_version %{version}a12

Name:           python-%{pypi_name}
Version:        4.2.0
Release:        0.1.a12%{?dist}
...
Requires:       python3-pulpcore >= 3.5.0
Conflicts:      python3-pulpcore >= 3.6
...
%changelog
* Mon Aug 10 2020 Evgeni Golov 4.2.0-0.1.a12
- Update to 4.2.0a12
