...
%changelog
* Mon Nov 28 2022 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 3.4.1-1
- Release foreman-proxy 3.4.1

* Thu Sep 08 2022 Odilon Sousa <osousa@redhat.com> - 3.4.0-1
- Release foreman-proxy 3.4.0

* Thu Aug 25 2022 Patrick Creech <pcreech@redhat.com> - 3.4.0-0.1.rc2
- Release foreman-proxy 3.4.0rc2

* Thu Aug 11 2022 Patrick Creech <pcreech@redhat.com> - 3.4.0-0.1.rc1
- Release foreman-proxy 3.4.0rc1
