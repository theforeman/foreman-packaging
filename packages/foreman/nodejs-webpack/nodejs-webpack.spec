...
Source29: https://registry.npmjs.org/baseline-browser-mapping/-/baseline-browser-mapping-2.11.6.tgz
...
Source68: nodejs-webpack-%{version}-registry.npmjs.org.tgz
BuildRequires: npm >= 7
...
Provides: bundled(npm(baseline-browser-mapping)) = 2.11.6
...
%setup -T -q -a 68 -D -n %{npm_cache_dir}
...
%changelog
* Wed Jul 29 2026 Foreman Packaging Automation <packaging@theforeman.org> 5.109.2-1
- Update to 5.109.2
