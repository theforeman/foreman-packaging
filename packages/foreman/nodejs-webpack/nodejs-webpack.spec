...
Source9: https://registry.npmjs.org/@types/node/-/node-25.3.5.tgz
...
Source32: https://registry.npmjs.org/baseline-browser-mapping/-/baseline-browser-mapping-2.10.0.tgz
...
Source35: https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001777.tgz
...
Source38: https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.5.307.tgz
Source39: https://registry.npmjs.org/enhanced-resolve/-/enhanced-resolve-5.20.0.tgz
...
Source60: https://registry.npmjs.org/node-releases/-/node-releases-2.0.36.tgz
...
Source67: https://registry.npmjs.org/tapable/-/tapable-2.3.0.tgz
Source68: https://registry.npmjs.org/terser/-/terser-5.46.0.tgz
Source69: https://registry.npmjs.org/terser-webpack-plugin/-/terser-webpack-plugin-5.3.17.tgz
Source70: https://registry.npmjs.org/undici-types/-/undici-types-7.18.2.tgz
...
Source73: https://registry.npmjs.org/webpack/-/webpack-5.105.4.tgz
...
Provides: bundled(npm(@types/node)) = 25.3.5
...
Provides: bundled(npm(baseline-browser-mapping)) = 2.10.0
Provides: bundled(npm(browserslist)) = 4.28.1
Provides: bundled(npm(buffer-from)) = 1.1.2
Provides: bundled(npm(caniuse-lite)) = 1.0.30001777
Provides: bundled(npm(chrome-trace-event)) = 1.0.4
Provides: bundled(npm(commander)) = 2.20.3
Provides: bundled(npm(electron-to-chromium)) = 1.5.307
Provides: bundled(npm(enhanced-resolve)) = 5.20.0
...
Provides: bundled(npm(node-releases)) = 2.0.36
...
Provides: bundled(npm(terser)) = 5.46.0
Provides: bundled(npm(terser-webpack-plugin)) = 5.3.17
Provides: bundled(npm(undici-types)) = 7.18.2
