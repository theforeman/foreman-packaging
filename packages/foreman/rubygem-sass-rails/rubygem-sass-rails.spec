...
Requires: %{?scl_prefix_ror}rubygem(sass) >= 3.1
Requires: %{?scl_prefix_ror}rubygem(sass) < 4
Requires: %{?scl_prefix_ror}rubygem(sprockets-rails) >= 2.0
Requires: %{?scl_prefix_ror}rubygem(sprockets-rails) < 4.0
Requires: %{?scl_prefix_ror}rubygem(sprockets) >= 2.8
