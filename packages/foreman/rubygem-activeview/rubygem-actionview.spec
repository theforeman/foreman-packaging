...
Requires: %{?scl_prefix_ror}rubygem(builder) >= 3.1
Requires: %{?scl_prefix_ror}rubygem(builder) < 4
Requires: %{?scl_prefix_ror}rubygem(erubi) >= 1.4
Requires: %{?scl_prefix_ror}rubygem(erubi) < 2
Requires: %{?scl_prefix_ror}rubygem(rails-html-sanitizer) >= 1.0
Requires: %{?scl_prefix_ror}rubygem(rails-html-sanitizer) < 2
Requires: %{?scl_prefix_ror}rubygem(rails-html-sanitizer) >= 1.0.3
