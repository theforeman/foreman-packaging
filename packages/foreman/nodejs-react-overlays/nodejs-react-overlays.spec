...
Name: %{?scl_prefix}nodejs-react-overlays
Version: 0.8.3
Release: 4%{?dist}
...
Requires: %{?scl_prefix}npm(dom-helpers) >= 3.2.1
Requires: %{?scl_prefix}npm(dom-helpers) < 4.0.0
Requires: %{?scl_prefix}npm(prop-types) >= 15.5.10
...
Requires: %{?scl_prefix}npm(react-transition-group) >= 2.2.0
Requires: %{?scl_prefix}npm(react-transition-group) < 3.0.0
...
%changelog
* Tue Mar 17 2020 Zach Huntington-Meath <zhunting@redhat.com> - 0.8.3-4
- Bump packages to build for el8

* Tue Oct 22 2019 Eric D. Helms <ericdhelms@gmail.com> - 0.8.3-3
- Build for SCL

* Fri Oct 04 2019 Eric D. Helms <ericdhelms@gmail.com> - 0.8.3-2
