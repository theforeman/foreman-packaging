...
Requires: %{?scl_prefix}rubygem(google-cloud-env) >= 1.0
...
%changelog
* Tue May 24 2022 Leos Stejskal <lstejska@redhat.com> 1.6.0-1
- Add rubygem-google-cloud-core generated by gem2rpm using the scl template
