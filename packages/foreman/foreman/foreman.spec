...
BuildRequires: npm(@novnc/novnc) = 1.3
...
BuildRequires: (npm(diff) >= 4.0.1 with npm(diff) < 5.0.0)
...
Requires: (npm(diff) >= 4.0.1 with npm(diff) < 5.0.0)
...
%changelog
* Fri Jun 20 2025 MariaAga <mariaaga@redhat.com> - 3.16.0-0.5.develop
