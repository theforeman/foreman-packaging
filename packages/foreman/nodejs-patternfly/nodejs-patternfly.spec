...
Requires: npm(bootstrap-datepicker) >= 1.7.1
Requires: npm(bootstrap-datepicker) < 2.0.0
...
Requires: npm(datatables.net-colreorder) >= 1.4.1
Requires: npm(datatables.net-colreorder) < 2.0.0
