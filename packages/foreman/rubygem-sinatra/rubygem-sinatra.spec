...
Requires: %{?scl_prefix_ror}rubygem(tilt) >= 2.0
Requires: %{?scl_prefix_ror}rubygem(tilt) < 3
Requires: %{?scl_prefix_ror}rubygem(rack-protection) = 2.0.3
Requires: %{?scl_prefix_ror}rubygem(mustermann) >= 1.0
Requires: %{?scl_prefix_ror}rubygem(mustermann) < 2
