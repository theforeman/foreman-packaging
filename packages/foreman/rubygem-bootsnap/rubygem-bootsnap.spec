...
BuildRequires: (rubygem(msgpack) >= 1.5 with rubygem(msgpack) < 2)
...
%changelog
* Sun Sep 06 2026 Eric D. Helms <ericdhelms@gmail.com> 1.26.0-1
- Add rubygem-bootsnap generated by gem2rpm using the default template
