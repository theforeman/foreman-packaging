...
%if 0%{?rhel} != 8
%{?scl:scl enable %{scl} - << \EOF}
ruby -I "%{buildroot}%{gem_libdir}" -e "require '%{gem_name}'"
%{?scl:EOF}
%endif
...
%changelog
* Thu Apr 09 2020 Zach Huntington-Meath <zhunting@redhat.com> - 2.2.1-2
- Adjust the spec to allow for building on el8
