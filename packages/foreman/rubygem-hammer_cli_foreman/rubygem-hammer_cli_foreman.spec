...
Requires: %{?scl_prefix}rubygem(hammer_cli) >= 0.17.0
...
%changelog
* Tue Aug 13 2019 Martin Bacovsky <mbacovsk@redhat.com> 0.17.2-1
- Update to 0.17.2

* Mon Jul 22 2019 Andrew Kofink <akofink@redhat.com> 0.17.1-1
- Update to 0.17.1

* Wed Apr 24 2019 Martin Bacovsky <mbacovsk@redhat.com> 0.17.0-1
- Update to 0.17.0
