...
Requires: %{?scl_prefix}rubygem(hammer_cli) >= 2.0.0
...
%changelog
* Tue Mar 24 2020 Shira Maximov <shiramaximov@gmail.com> 2.0.2-1
- Update to 2.0.2

* Tue Feb 25 2020 Oleh Fedorenko <ofedoren@redhat.com> 2.0.1-1
- Update to 2.0.1
