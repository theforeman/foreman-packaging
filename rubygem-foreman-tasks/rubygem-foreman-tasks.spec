...
BuildRequires: %{?scl_prefix}rubygem(dynflow) >= 0.8.22
...
%changelog
* Thu Sep 28 2017 Eric D. Helms <ericdhelms@gmail.com> 0.9.6-1
- Update foreman-tasks to 0.9.6 (inecas@redhat.com)
